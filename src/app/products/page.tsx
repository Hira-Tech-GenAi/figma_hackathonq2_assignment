    ...
    <>
      <section className="w-full mt-[57px]">
        ...
        <div className="w-full text-center mt-[173px] py-[100px] bg-[#F0F2F3]">
          <h1 className="text-[50px] leading-[58px] font-medium ">
          ...
          <div className="flex items-center justify-center gap-[74ppx] mt-[20px] text-black">
            <div className="border-b-[2px] border-black">
              <Input
                ...
                className="w-[643px] h-[32px] border-none border-b-[2px] text-[16px] leadin-[16px] py-[15px] px-[20px]"
              />
            </div>

            <div className="border-b-[2px] border-black ml-[8px] mb-[2px]">
              <Button className="text-[16px] leadin-[110%] font-semibold py-[14px] px-[24px] bg-transparent text-black shadow-none">
                Subscribe
              </Button>
            </div>
          </div>
          ...
          {/* heading 2 */}
          <h1 className="text-[50px] leading-[58px] font-medium mt-[70px]">
